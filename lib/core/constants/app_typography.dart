...
class AppTypography {
  ...
  static TextStyle titleSmall({Color color = AppColors.ink}) =>
      GoogleFonts.inter(
        fontSize: 13,
        fontWeight: FontWeight.w600,
        color: color,
  ...
  static TextStyle bodyMedium({Color color = AppColors.inkSoft}) =>
      GoogleFonts.inter(
        fontSize: 13,
        fontWeight: FontWeight.w400,
        color: color,
  ...
  static TextStyle bodySmall({Color color = AppColors.inkSoft}) =>
      GoogleFonts.inter(
        fontSize: 12,
        fontWeight: FontWeight.w400,
        color: color,
